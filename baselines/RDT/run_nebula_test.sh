...
echo "Starting NEBULA RDT evaluation experiments..."
echo "================================================"

# Run capability tests
echo "Running capability tests..."
python rdt_simulation.py --config $CONFIG_FILE --test-type capability
...
python rdt_simulation.py --config $CONFIG_FILE --test-type stress
STRESS_EXIT_CODE=$?
