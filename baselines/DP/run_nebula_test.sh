...
echo "Starting NEBULA DP evaluation experiments..."
echo "================================================"

# Run capability tests
echo "Running capability tests..."
python dp_simulation.py --config $CONFIG_FILE --test-type capability
...
python dp_simulation.py --config $CONFIG_FILE --test-type stress
STRESS_EXIT_CODE=$?
