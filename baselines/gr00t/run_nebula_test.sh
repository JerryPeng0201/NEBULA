...
echo "Starting NEBULA GR00T evaluation experiments..."
echo "================================================"

# Run capability tests
echo "Running capability tests..."
python gr00t_simulation.py --config $CONFIG_FILE --test-type capability
...
python gr00t_simulation.py --config $CONFIG_FILE --test-type stress
STRESS_EXIT_CODE=$?
