...
echo "Starting NEBULA $MODEL_NAME evaluation experiments..."
echo "================================================"

# Run capability tests
echo "Running capability tests..."
python model_simulation.py --config $CONFIG_FILE --test-type capability
...
python model_simulation.py --config $CONFIG_FILE --test-type stress
STRESS_EXIT_CODE=$?
