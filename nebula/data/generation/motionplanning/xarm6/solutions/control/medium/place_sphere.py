...
def ControlPlaceSphereMediumSolution(env: ControlPlaceSphereMediumEnv, seed=None, debug=False, vis=False):
    ...
    # -------------------------------------------------------------------------- #
    reach_pose = initial_grasp_pose * sapien.Pose([0, 0, -0.08])
    ...
    # -------------------------------------------------------------------------- #
    lift_pose = sapien.Pose([0, 0, 0.13]) * initial_grasp_pose
    ...
    # -------------------------------------------------------------------------- #
    retreat_pose = purple_place_pose * sapien.Pose([0, 0, -0.08])
    ...
    # -------------------------------------------------------------------------- #
    lift_pose_2 = sapien.Pose([0, 0, 0.13]) * reach_pose_2
