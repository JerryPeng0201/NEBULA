...
def ControlStackCubeHardSolution(env: ControlStackCubeHardEnv, seed=None, debug=False, vis=False):
    ...
    # Reach red cube
    reach_pose_red = red_grasp_pose * sapien.Pose([0, 0, -0.08])
    ...
    # Lift red cube
    lift_pose_red = sapien.Pose([0, 0, 0.11]) * red_grasp_pose  # Higher lift for cubes
    ...
    # Reach blue cube
    reach_pose_blue = blue_grasp_pose * sapien.Pose([0, 0, -0.08])
    ...
    # Lift blue cube
    lift_pose_blue = sapien.Pose([0, 0, 0.15]) * blue_grasp_pose  # Higher lift to clear other cubes
    ...
    approach_pos[2] += 0.06  # 3cm above position
    ...
    # Reach purple cube
    reach_pose_purple = purple_grasp_pose * sapien.Pose([0, 0, -0.08])
