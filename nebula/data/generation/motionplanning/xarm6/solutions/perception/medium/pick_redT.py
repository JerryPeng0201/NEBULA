...
import random
import torch
from nebula.benchmarks.capabilities.perception.medium.pick_redT import PerceptionPickRedTMediumEnv
...
def PerceptionPickRedTMediumSolution(env: PerceptionPickRedTMediumEnv, seed=None, debug=False, vis=False):
    """
    Perception task solution: Only grasp the red T-shape.
