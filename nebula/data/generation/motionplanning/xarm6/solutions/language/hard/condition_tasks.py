...
from nebula.benchmarks.capabilities.language.hard.condition_tasks import LanguageConditionHardEnv
...
def LanguageConditionHardSolution(env: LanguageConditionHardEnv, seed=None, debug=False, vis=False):
    """
