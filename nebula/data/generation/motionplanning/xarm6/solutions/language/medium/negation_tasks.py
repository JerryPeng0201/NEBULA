...
from nebula.benchmarks.capabilities.language.medium.negation_tasks import LanguageNegationMediumEnv
...
def LanguageNegationMediumSolution(env: LanguageNegationMediumEnv, seed=None, debug=False, vis=False):
    """
