...
def place_object_at_position(planner, base_env, obj, target_position, object_name, description=""):
    ...
    try:
        ...
        # Lift
        # -------------------------------------------------------------------------- #
        lift_height = 0.13 if object_name != "triangle" else 0.15
        ...
        # -------------------------------------------------------------------------- #
        hover_height = 0.13 if object_name != "triangle" else 0.15
        ...
        # Retreat
        # -------------------------------------------------------------------------- #
        retreat_height = 0.15 if object_name != "triangle" else 0.18
