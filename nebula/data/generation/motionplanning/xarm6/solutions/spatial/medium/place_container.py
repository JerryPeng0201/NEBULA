...
def SpatialMediumPlaceContainerSolution(env, seed=None, debug=False, vis=False):
    ...
    # 3. Lift
    lift_height = 0.18 if target_direction == "inside" else 0.08
    ...
    if target_direction == "inside":
        ...
        above_container_pose = sapien.Pose(
            [container_pos[0], container_pos[1], container_pos[2] + 0.13],
            grasp_pose.q
        )
    ...
    retreat_offset = [0, 0, -0.11] if target_direction != "bottom" else [0.1, 0, 0]
