...
import random
from nebula.benchmarks.capabilities.spatial.easy.pick_cube import SpatialEasyPickCubeEnv
...
def SpatialEasyPickCubeSolution(env: SpatialEasyPickCubeEnv, seed=None, debug=False, vis=False):
    env.reset(seed=seed)
