...
from nebula.data.generation.motionplanning.xarm6.config import SOLUTIONS_CONFIG
...
def parse_args(args=None):
    ...
    parser.add_argument("--subtask-idx", type=int, default=0, help="The subtask index to run. 0 for peg insertion, 1 for stack cube")
...
def _main(args, proc_id: int = 0, start_seed: int = 0) -> str:
    ...
    print(f"Motion Planning Running on {env_id} with XArm6 GripperG2")
