...
import random
from nebula.envs.tasks.capabilities.spatial.medium.pick_closest import SpatialMediumPickClosestEnv
...
def solve(env: SpatialMediumPickClosestEnv, seed=None, debug=False, vis=False):
