...
from nebula import format_path
from .actuators.joint_position_control import (
    JointPositionController,
    JointPositionControllerConfig,
)
from nebula.core.sensors.base_sensor import BaseSensor, BaseSensorConfig
from nebula.utils import assets, download_asset, sapien_utils
from nebula.utils.logging_utils import logger
from nebula.utils.structs import Actor, Array, Articulation
from nebula.utils.structs.pose import Pose

from .actuators.base_actuator import (
    ActuatorController,
    CombinedController,
    ControllerConfig,
)
...
class BaseAgent:
    ...
    def __init__(
        ...
        self.controllers: Dict[str, ActuatorController] = dict()
    ...
    def _controller_configs(
        ...
        """Returns a dict of controller configs for this agent. By default this is a JointPosition (delta and non delta) controller for all active joints."""
        return dict(
            pd_joint_pos=JointPositionControllerConfig(
            ...
            pd_joint_delta_pos=JointPositionControllerConfig(
                [x.name for x in self.robot.active_joints],
                lower=-0.1,
                upper=0.1,
                stiffness=100,
    ...
    @property
    def controller(self) -> ActuatorController:
