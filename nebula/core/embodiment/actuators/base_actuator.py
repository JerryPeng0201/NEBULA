...
from nebula.core.embodiment.utils import (
    flatten_action_spaces,
    get_active_joint_indices,
    get_joints_by_names,
)
from nebula.utils import common, gym_utils
from nebula.utils.structs import Articulation, ArticulationJoint
...
class ControllerConfig:
    ...
    controller_cls = ActuatorController


# -------------------------------------------------------------------------- #
# Composite controllers
# -------------------------------------------------------------------------- #
class DictController(ActuatorController):
    def __init__(
        self,
