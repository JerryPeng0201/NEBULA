...
from nebula.utils import common
from nebula.utils.logging_utils import logger
from nebula.utils.structs.types import Array, DriveMode

from .base_actuator import ActuatorController, ControllerConfig


class JointPositionController(ActuatorController):
...
@dataclass
class JointPositionControllerConfig(ControllerConfig):
...
class PDJointPosMimicController(JointPositionController):
...
@dataclass
class PDJointPosMimicControllerConfig(JointPositionControllerConfig):
    """
...
PDJointPosController = JointPositionController
PDJointPosControllerConfig = JointPositionControllerConfig
