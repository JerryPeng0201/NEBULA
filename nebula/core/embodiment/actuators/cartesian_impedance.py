...
from nebula.core.embodiment.actuators.kinematics.solver import Kinematics
from nebula.utils import gym_utils, sapien_utils
...
from nebula.utils.structs.types import Array, DriveMode

from .base_actuator import ControllerConfig
from .joint_position_control import JointPositionController as PDJointPosController
...
class CartesianImpedanceController(PDEEPosController):
    config: "CartesianImpedanceControllerConfig"
...
@dataclass
class CartesianImpedanceControllerConfig(PDEEPosControllerConfig):
...
# Backward compatibility aliases (for robot configuration files)
PDEEPoseController = CartesianImpedanceController
PDEEPoseControllerConfig = CartesianImpedanceControllerConfig
