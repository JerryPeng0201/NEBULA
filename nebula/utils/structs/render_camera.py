...
from nebula.utils.geometry.rotation_conversions import quaternion_to_matrix
...
class RenderCamera:
    ...
    name: str
    # NOTE (stao): I cannot seem to use NEBULAScene as a type here, it complains it is undefined despite using TYPE_CHECKING variable. Without typchecking there is a ciruclar import error
    scene: Any
