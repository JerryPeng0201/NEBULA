...
from nebula.utils.geometry.trimesh_utils import (
    get_render_shape_meshes,
    merge_meshes,
)
from nebula.utils.structs.articulation_joint import ArticulationJoint
from nebula.utils.structs.base import PhysxRigidBodyComponentStruct
...
if TYPE_CHECKING:
    ...
    from nebula.utils.structs import Articulation
