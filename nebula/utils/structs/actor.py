...
from nebula.utils.geometry.trimesh_utils import get_component_meshes, merge_meshes
from nebula.utils.structs.base import PhysxRigidDynamicComponentStruct
from nebula.utils.structs.pose import Pose, to_sapien_pose, vectorize_pose
...
class Actor(PhysxRigidDynamicComponentStruct[sapien.Entity]):
    ...
    def merge(cls, actors: List["Actor"], name: str = None):
        ...
        For example usage of this method, see nebula/envs/tasks/pick_single_ycb.py
