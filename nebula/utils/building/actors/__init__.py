...
def get_actor_builder(
    scene: NEBULAScene, id: str, add_collision: bool = True, add_visual: bool = True
) -> ActorBuilder:
    ...
    Args:
        scene: The NEBULAScene. If building a custom task this is generally just self.scene
    ...
    if dataset_source == "ycb":
        from nebula.utils.building.actors.ycb import get_ycb_builder
