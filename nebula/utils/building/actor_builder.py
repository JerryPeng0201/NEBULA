...
from nebula.utils.structs.pose import Pose, to_sapien_pose
...
class ActorBuilder(SAPIENActorBuilder):
    ...
    def build(self, name):
        ...
        if self.initial_pose is None:
            logger.warn(
                f"No initial pose set for actor builder of {self.name}, setting to default pose q=[1,0,0,0], p=[0,0,0]. Not setting reasonable initial poses may slow down simulation."
            )
