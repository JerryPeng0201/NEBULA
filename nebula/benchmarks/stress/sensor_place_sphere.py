...
@register_env("Sensor-PlaceSphere-Easy", max_episode_steps=50)
class SensorPlaceSphereEasyEnv(BaseEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def __init__(self, *args, robot_uids="panda", robot_init_qpos_noise=0.02, post_process_method=["rgb+light_flicker+50"], **kwargs):
    ...
    def _build_bin(self, radius):
        ...
        builder.initial_pose = sapien.Pose(p=[0, 0, self.block_half_size[0]])
    ...
    def _load_scene(self, options: dict):
        ...
        self.bin.set_pose(Pose.create_from_pq(p=[0, 0, self.block_half_size[0]], q=[1, 0, 0, 0]))
