...
from nebula.utils import common, io_utils, sapien_utils
...
@register_env(
    "Robust-AssemblingKits-Hard", asset_download_ids=["assembling_kits"], max_episode_steps=200
)
class RobustHardAssemblingKitsEnv(BaseEnv):
    """
    **Task Description:**
