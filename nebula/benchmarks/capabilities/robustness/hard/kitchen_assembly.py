...
@register_env("Robust-KitchenAssembly-Hard", max_episode_steps=200)
class RobustHardKitchenAssemblyEnv(BaseEnv):
...
RobustHardKitchenAssemblyEnv.__doc__ = SPATIAL_KITCHEN_ASSEMBLY_DOC_STRING