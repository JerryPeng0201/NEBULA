...
class PerceptionPickSphereEasyEnv(BaseEnv):
    """
    **Task Description:**
    Grasp the sphere (red sphere) among two objects of different shapes (blue cube and red sphere).
    This is a perception task that tests the robot's ability to identify and grasp the 
    correct object based on shape.

    **Randomizations:**
    - The objects are placed at fixed positions: blue cube at x=-0.08, y=-0.05 and 
    red sphere at x=-0.08, y=0.05, ensuring a consistent distance of 0.1 units between them.
    ...
    **Success Conditions:**
    ...
    def compute_dense_reward(self, obs: Any, action: torch.Tensor, info: Dict):
        ...
        # grasp reward - reward for grasping the correct (red sphere) object
