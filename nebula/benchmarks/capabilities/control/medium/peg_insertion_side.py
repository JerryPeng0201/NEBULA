...
from nebula.core.embodiment.robots.panda import PandaWristCam
...
from nebula.utils.structs import Actor, Pose
from nebula.utils.structs.types import SimConfig


def _build_box_with_hole(
    scene: NEBULAScene, inner_radius, outer_radius, depth, center=(0, 0)
):
...
@register_env("Control-PegInsertionSide-Medium", max_episode_steps=100)
class ControlPegInsertionSideMediumEnv(BaseEnv):
    """
    **Task Description:**
