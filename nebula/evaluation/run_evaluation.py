...
from nebula.evaluation.evaluator import BaseEvaluator
from nebula.utils.io_utils import dump_json, load_json, write_txt
...
def main():
    ...
    if args.use_random_policy:
        from nebula.evaluation.solution import RandomPolicy
